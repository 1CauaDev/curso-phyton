...
taxa_de_cambio = obter_taxa()
valor = float(input(" Qual valor a ser convertido : "))
moeda_origem = input("Qual é a moeda de origem : ").upper()
moeda_destino = input("Qual é a moeda de destino :").upper()
...
if valor_convertido is not None:
    ...
    print("Moedas nao encontradas ou invalidas")   
